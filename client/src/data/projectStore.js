const data = {
  ...
  projects: [
    {
      ...
      description:
        'A user-friendly to-do list tracker for efficient task management.',
      summary:
        'Structured a JSON object to store to-do lists and tasks. Implemented HTML for the frontend user interface, ensuring a responsive and accessible design. Incorporated a custom CSS stylesheet for a visually appealing and user-friendly interface. Employed well-structured JavaScript functions to facilitate comprehensive CRUD operations on both to-do lists and their associated tasks.',
    ...
    },
    {
      ...
      date_finished: 'October, 2023',
      description:
        'Helps users track their pantry items and create gorcery lists.',
      summary:
        'Utilized JSON server to store pantry items and their attributes. Implemented the React framework for the frontend user interface. Incorporated a custom CSS stylesheet for styling and design. Included full CRUD operations on pantry items.',
  ...
  links: [
    'https://www.linkedin.com/in/mark-pierce-410326100/',
    'https://github.com/ajineer',
    'https://medium.com/@ajineer',
  ],
  pageLinks: [
    {
      link: 'top',
