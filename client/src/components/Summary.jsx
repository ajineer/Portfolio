...
function Summary(){
    ...
    return (
        ...
        // <div className={`grid grid-cols-8 grid-rows-8 w-[80%] h-[90%]`}>
            
            <h1 className={`flex col-span-3 row-span-1 p-2 border-2 border-orange-500'}`}>
                Mark Pierce
            </h1>
            
        //     <p className={`col-span-3 row-span-4 border-2 border-orange-500 row-start-4 col-start-1`}>
